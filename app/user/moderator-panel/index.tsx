  ...
  import AdminKpiCard from "@/components/common/moderatorcard";
import ModerationMenuItem from "@/components/moderationItem";
  import {
  ...
  export default function CommunityModerationPanelScreen() {
    ...
    {canManageMembers ? (
      <>
        <ModerationMenuItem
          ...
          onPress={() => {
            router.push({
              pathname: "/user/moderator-panel/join-requests",
              params: {
                slug: slug ?? "",
              },
            });
        ...
        <ModerationMenuItem
          ...
          onPress={() => {
            router.push({
              pathname: "/user/moderator-panel/members",
              params: {
                slug: slug ?? "",
              },
            });
    ...
    {canManagePosts ? (
      <ModerationMenuItem
        ...
        onPress={() => {
          router.push({
            pathname: "/user/moderator-panel/posts",
            params: {
              slug: slug ?? "",
            },
          });
